...
// Core strategy types
pub use strategy::{CompactionPlan, CompactionSnapshot, CompactionStrategy, ContentOverrideEntry};
...
pub use service::{CompactConfig, Compactor, DEFAULT_COMPACT_THRESHOLD, PreparedCompact};
